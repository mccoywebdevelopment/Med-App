...
class PopUp extends React.Component {
    ...
    constructor(props) {
        ...
        if (this.props.popUp && this.props.popUp.component && this.props.popUp.component.type && this.props.popUp.component.type.compare == null ||
            this.props.popUp && this.props.popUp.component && this.props.popUp.component.key == null) {
    ...
    render() {
        ...
        return (
            <>
                {false?/* {this.props.popUp && this.props.popUp.component && this.props.popUp.component.key == null ? */
                    <h1>error</h1>
                    :
                    <StyleRoot>
