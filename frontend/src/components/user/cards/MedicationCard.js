                ...
                <div className="card w-100 medication-card" style={cardStyle} onClick={()=>{this.props.selectMedCart(this.props.data,this.props.isHistory)}}>
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-4">
                                <h4 style={{margin:'0px',paddingTop:'20%',color:"rgb(33, 150, 243)",fontWeight:'bold',fontSize:"1.2rem"}}> {this.props.data.rxsMedication.dosage.quantity} {this.props.data.rxsMedication.dosage.unit}</h4>
                            </div>
                        </div>
                    </div>
                </div>
